...
\t\tdefault:OFF"
    ...
    if bits not in bits_list:
        return Utility.handle_error(Utility.handle_errorno['handle_errno_parameter_invalid'],"bits param error")

    if stop not in stop_list:
        return Utility.handle_error(Utility.handle_errorno['handle_errno_parameter_invalid'],"stop param error")

    if parity not in parity_list:
        return Utility.handle_error(Utility.handle_errorno['handle_errno_parameter_invalid'],"parity param error")
