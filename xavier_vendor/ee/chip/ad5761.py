...
class AD5761():
    ...
    def __init__(self,device_name, vref = 2500, control_reg_data = 0x0164):
        ...
        if 0x20 == (control_reg_data & 0x20):
            self.__vref = 2500 # use internal 2.5V voltage reference
        else:
        ...
        '''Set output voltage
            ...
            returns:
                ...
                if failed:
                    False
        '''
        dac_data = int((volt / self.__vref + self.__c) / self.__m * (2**16 - 1) + 0.5)
